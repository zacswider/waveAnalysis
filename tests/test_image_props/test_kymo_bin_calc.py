...
def test_kymo_bin_calc(default_bin_values):
    ...
    default_dicts = [
        '/Users/domchom/Documents/GitHub/ZS_wave_analysis/tests/assets/kymo/dicts_lists/kymo_image_properties_1_Group1_final.json',
        '/Users/domchom/Documents/GitHub/ZS_wave_analysis/tests/assets/kymo/dicts_lists/kymo_image_properties_1_Group2_final.json'
    ]
