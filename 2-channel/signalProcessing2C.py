...
for file_index, fileName in enumerate(fileNames):                                 # iterates through the .tif files in the specified directory
...
#################################################################
    ...
    if imageChannels == 1:   
        ...
        print(str(round((file_index+1)/len(fileNames)*100, 1)) + 
